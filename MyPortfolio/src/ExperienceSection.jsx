            ...
            {filteredExperiences.map((exp, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`relative bg-gradient-to-br from-zinc-900/90 to-black/90 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-6 shadow-2xl shadow-black/50 overflow-hidden ${
